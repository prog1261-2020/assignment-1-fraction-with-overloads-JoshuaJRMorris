...
TEST(FractionTest, addTest04) {
	...
	f1 += 1;
	Fraction expectedResult(3, 2);			//+= Fraction and Int
...
TEST(FractionTest, subTest04) {
	...
	f1 -= 1;
	Fraction expectedResult(-1, 2);			//-= Fraction and Int
...
TEST(FractionTest, multTest02) {
	...
	Fraction expectedResult(3, 2);				// * Fraction and Int with negatives
...
TEST(FractionTest, divTest02) {
	...
	Fraction expectedResult(1, 6);				//[/] with fraction and Int
...
TEST(FractionTest, divTest02b) {
	...
	Fraction expectedResult(6, 1);				//[/] with Int and Fraction
...
//	Fraction f1;
//	std::istringstream si(std::string("-5/22"));				//is test
//	si >> f1;
